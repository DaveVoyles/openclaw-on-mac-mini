...
EXPECTED_COMMAND_COUNT = 57  # includes /adguard, /arr, /copilot ×5 subcommand handlers, /downloads, /grafana, /h, /hermes, /host, /incident, /media, /morning, /nas, /news, /notify, /plex, /q, /qbt, /request, /resume, /sessions, /status, /tailscale, /upcoming, /uptime, /wake, /watching, etc.
