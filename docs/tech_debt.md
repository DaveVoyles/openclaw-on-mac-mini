...
| TD-28 | Create `openclaw_cli_types.py` — move ChatCommandContext, SlashCommand, ChatCommandRegistry, AskResponse, LocalLinkValidation, CliConfig to leaf module (0 deps) | 🟢 Low | ✅ Done — April 2026 (`0e47b88`) |
| TD-29 | Extract `openclaw_cli_cmd_settings.py` — 12 settings/appearance handlers (_cmd_theme, _cmd_emoji, _cmd_layout, _cmd_accessibility, etc., 588L) | 🟢 Low | ✅ Done — April 2026 (`abf0e67`) |
| TD-30 | Extract `openclaw_cli_cmd_session.py` — 10 session lifecycle handlers (_cmd_session, _cmd_events, _cmd_replay, _cmd_bookmark, _cmd_handoff, etc., 778L) | 🟡 Medium | ✅ Done — April 2026 (`abf0e67`) |
| TD-31 | Extract `openclaw_cli_cmd_workflow.py` — 12 workflow/automation handlers (_cmd_plan, _cmd_task, _cmd_workspace, _cmd_macro, _cmd_workflow, _cmd_dashboard, etc.) | 🔴 High | ✅ Done — April 2026 (`4177c2c`) |
| TD-32 | Extract `openclaw_cli_cmd_content.py` — 10 content/analytics handlers (_cmd_outputs, _cmd_search, _cmd_history, _cmd_pin, _cmd_pattern, _cmd_stats, _cmd_timeline, etc., 1100L) | 🟡 Medium | ✅ Done — April 2026 (`abf0e67`) |
| TD-33 | Extract `openclaw_cli_cmd_core.py` — 24 system/file/exec handlers (_cmd_help, _cmd_exec, _cmd_edit, _cmd_autoroute, _cmd_analyze, _cmd_runbook, _cmd_draft, etc.) | 🟡 Medium | ✅ Done — April 2026 (`79f1da0`) |
| TD-34a | Extract `openclaw_cli_cmd_misc.py` — 15 UX/history/analytics handlers (_cmd_recall, _cmd_rate, _cmd_streak, _cmd_heatmap, _cmd_diff, _cmd_changes, etc.) | 🟢 Low | ✅ Done — April 2026 (`65fe303`) |
| TD-34b | Extract `openclaw_cli_cmd_system.py` — 11 system/prompt handlers (_cmd_system, _cmd_alias, _cmd_palette, _cmd_prompt, _cmd_benchmark, etc.) | 🟢 Low | ✅ Done — April 2026 (`521dde2`) |

**Actual impact TD-8 through TD-34:** `openclaw_cli.py` reduced from 14,813 → 4,654 lines (−**69%**).
TD-34 completed the final `build_parser` + `print_chat_help` extraction into `openclaw_cli_cli_parser.py` and `openclaw_cli_help.py`.
