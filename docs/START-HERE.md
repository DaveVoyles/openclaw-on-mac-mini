...
> **Not a developer?** If you just want to use OpenClaw to edit documents, ask questions, or chat — start with the **[Non-Technical User Guide](../templates/parents-guide.html)** instead.
