...
| **LLM Model**           | Gemini 2.5 Flash (tool use) + Ollama gemma4:e4b (local, free) | Hybrid routing: ~70% of queries go to local Ollama at zero cost; only tool-requiring queries hit Gemini. gemma4:e4b chosen for best quality/speed on M4 16 GB (9.6 GB). |
...
| #   | Item                                    | Where                                                 | What                                                                                                                                                                | Status |
| --- | --------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 1   | **Fix stale Ollama model references**   | `config/config.yaml`, `README.md`, `docs/COMMANDS.md` | Updated 6 `llama3.2:3b` → `gemma4:e4b` references across 3 files                                                                                                    | ✅     |
