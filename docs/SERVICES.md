...
| **DuckDuckGo (Lite)** | https://lite.duckduckgo.com | Privacy-focused web search, no API key required         | Free fallback web search with no rate limits or registration                                                                                                    | _(none)_                                |
| **Bing Search**       | https://www.bing.com        | General web search                                      | Second fallback when DuckDuckGo fails                                                                                                                           | _(none)_                                |
