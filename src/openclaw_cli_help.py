...
def print_chat_help(*, search: str = "") -> None:
    ...
    commands = [
        ...
        ("/session", "Show current session summary with read-only trust/recovery cues"),
        ...
        ("/collab [status|share|assign]", "Show or extend the local read-only handoff summary for the current session"),
